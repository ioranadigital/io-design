...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: 'IoranaSEO',
    title: 'IoranaSEO - Agencia de Marketing Digital',
    description: 'Expertos en SEO, Google Ads, Facebook Ads y soluciones digitales.',
    images: [
      {
  ...
  return (
    <html lang="es">
      <head>
        ...
        {/* DNS Prefetch */}
        <link rel="dns-prefetch" href="https://zvehtloitnuglyjtxwye.supabase.co" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              sameAs: ['https://twitter.com/iorana', 'https://linkedin.com/company/iorana'],
              contact: {
                '@type': 'ContactPoint',
