...
**Sistema de diseño y componentes compartidos**
...
1 Revisar/actualizar componentes
...
Ver componentes: `pnpm run storybook` (si aplica)
Compilar: `pnpm run build`

**Acceso:** http://localhost:4005 (Storybook)

**Tipo:** Librería de componentes
...
- src/styles/ - Tokens y variables de diseño
- src/icons/ - Iconografía
...
8 Tipo: Librería/Sistema de Diseño
