...
**Gestor de presupuestos y gastos**
...
- src/components/budget/ - Componentes de presupuesto
- src/lib/calculations/ - Lógica de cálculos
- database/ - Esquema de datos
